...
@Component({
    selector     : 'elisa-scrumboard-board-card-dialog',
    templateUrl  : './card.component.html',
    styleUrls    : ['./card.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ElisaScrumboardCardDialogComponent implements OnInit, OnDestroy
{
    card: any;
    board: any;
    list: any;
    ...
    constructor(
        public dialogRef: MatDialogRef<ElisaScrumboardCardDialogComponent>,
