...
@Component({
    selector   : 'elisa-chat-view',
    templateUrl: './chat-view.component.html',
    styleUrls  : ['./chat-view.component.scss']
})
export class ElisaChatViewComponent implements OnInit, AfterViewInit
{
    user: any;
    chat: any;
    dialog: any;
    ...
    replyInput: any;
    selectedChat: any;
    @ViewChild(ElisaPerfectScrollbarDirective) directiveScroll: ElisaPerfectScrollbarDirective;
