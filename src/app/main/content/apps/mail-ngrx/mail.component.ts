...
export class ElisaMailNgrxComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        private configService: ElisaConfigService,
        private mailService: MailNgrxService,
        private translationLoader: ElisaTranslationLoaderService,
