...
@Component({
    selector   : 'elisa-e-commerce-products',
    templateUrl: './products.component.html',
    styleUrls  : ['./products.component.scss'],
    animations : elisaAnimations
})
export class ElisaEcommerceProductsComponent implements OnInit
{
...
export class FilesDataSource extends DataSource<any>
{
    ...
    filterData(data)
    {
        ...
        return ElisaUtils.filterArrayByString(data, this.filter);
    }
