...
@Component({
    selector     : 'elisa-contacts-contact-list',
    templateUrl  : './contact-list.component.html',
    styleUrls    : ['./contact-list.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : elisaAnimations
})
export class ElisaContactsContactListComponent implements OnInit, OnDestroy
{
    ...
    editContact(contact)
    {
        this.dialogRef = this.dialog.open(ElisaContactsContactFormDialogComponent, {
