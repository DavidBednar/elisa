...
@Component({
    selector     : 'elisa-knowledge-base',
    templateUrl  : './knowledge-base.component.html',
    styleUrls    : ['./knowledge-base.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ElisaKnowledgeBaseComponent implements OnInit, OnDestroy
{
    knowledgeBase: any;
    ...
    readArticle(article)
    {
        this.matDialog.open(ElisaKnowledgeBaseArticleComponent, {
