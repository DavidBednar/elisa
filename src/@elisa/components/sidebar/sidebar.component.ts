...
import { ElisaSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'elisa-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class ElisaSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
     ...
     * @param {ElisaConfigService} elisaConfigService
     * @param {ElisaSidebarService} elisaSidebarService
     * @param {ElisaMatchMediaService} elisaMatchMediaService
     */
    constructor(
        ...
        private elisaConfigService: ElisaConfigService,
        private elisaSidebarService: ElisaSidebarService,
        private elisaMatchMediaService: ElisaMatchMediaService
    )
    {
        // Set the defaults
        this.opened = false;
    ...
    ngOnInit(): void
    {
        ...
        this.elisaSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this.elisaSidebarService.unregister(this.name);
    ...
    private _setupLockedOpen(): void
    {
        ...
        this._onMediaChangeSubscription =
            ...
            this.elisaMatchMediaService.onMediaChange.subscribe(() => {
                ...
                if ( isActive )
                {
                    ...
                    if ( this.elisaConfigService.config.layout.navigationFolded )
                    {
                        this.fold();
                    }
    ...
    showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('elisa-sidebar-overlay');
