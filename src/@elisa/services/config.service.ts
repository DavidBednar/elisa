...
const DEFAULT_CONFIG = {
    ...
    colorClasses    : {
        ...
        navbar : 'mat-elisa-dark-700-bg',
        footer : 'mat-elisa-dark-900-bg'
    },
...
export const ELISA_CONFIG = new InjectionToken('elisaCustomConfig');

@Injectable()
export class ElisaConfigService
{
    config: any;
    defaultConfig: any;
    ...
    constructor(
        ...
        @Inject(ELISA_CONFIG) @Optional() config
    )
    {
