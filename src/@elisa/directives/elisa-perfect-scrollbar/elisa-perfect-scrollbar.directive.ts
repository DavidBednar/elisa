...
@Directive({
    selector: '[elisaPerfectScrollbar]'
})
export class ElisaPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
    ...
    ngOnInit()
    {
        this.onConfigChanged =
            this.elisaConfig.onConfigChanged.subscribe(
                (settings) => {
